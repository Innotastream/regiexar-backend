...
<body>
  <main class="shell">
    ...
    <section id="studioPanel" class="hidden">
      ...
      <p class="notice">« Retirer » masque l’image de votre collection et programme la suppression du fichier privé lorsqu’il n’est ni publié ni utilisé. Le journal de la conversation reste conservé et visible par l’administrateur.</p>
    ...
    async function loadHistory() {
      ...
      try {
        ...
        for (const conversation of payload.conversations) {
          ...
          historyConversations.append(button);
        }
