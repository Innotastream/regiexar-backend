...
const XAR_BACKEND_VERSION = '0.17.4';
const XAR_BACKEND_BUILD = 'client-3-3-9-native-map-gestures-candidate-20260923-1';
const XAR_RELEASE_ANNOUNCEMENT_VERSION = '3.3.9';
// La santé et les informations Store restent publiques, mais seule la version courante peut ouvrir une session.
const XAR_RELEASE_ALLOWED_CLIENT_VERSIONS = ['3.3.9'];
