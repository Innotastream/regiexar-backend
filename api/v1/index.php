...
const XAR_BACKEND_VERSION = '0.18.11';
const XAR_BACKEND_BUILD = 'client-3-4-9-wall-shadow-vision-edge-20260926-1';
const XAR_RELEASE_ANNOUNCEMENT_VERSION = '3.4.9';
// La santé et les informations Store restent publiques, mais seule la version courante peut ouvrir une session.
const XAR_RELEASE_ALLOWED_CLIENT_VERSIONS = ['3.4.9'];
