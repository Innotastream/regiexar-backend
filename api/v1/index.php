...
const XAR_BACKEND_VERSION = '0.15.0';
const XAR_BACKEND_BUILD = 'client-3-2-0-individual-vision-stream-and-layers-release-20260907-1';
const XAR_RELEASE_ANNOUNCEMENT_VERSION = '3.2.0';
