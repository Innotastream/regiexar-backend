...
const XAR_BACKEND_VERSION = '0.15.13';
const XAR_BACKEND_BUILD = 'client-3-2-13-media-targeting-stream-light-candidate-20260911-1';
const XAR_RELEASE_ANNOUNCEMENT_VERSION = '3.2.13';
// La santé et les informations Store restent publiques, mais seule la version courante peut ouvrir une session.
const XAR_RELEASE_ALLOWED_CLIENT_VERSIONS = ['3.2.13'];
