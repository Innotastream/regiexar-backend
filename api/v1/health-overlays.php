...
function healthOverlayProjection(array $character, array $record): array
{
    ...
    return [
        'name' => onlineUtf8ByteSlice(trim((string) ($character['name'] ?? 'Personnage')), 120) ?: 'Personnage',
