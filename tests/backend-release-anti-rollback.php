...
checkReleasePolicy(backendReleaseVersionStatus(null, '0.16.1') === 'initialize', 'Une table absente peut être initialisée.');
checkReleasePolicy(backendReleaseVersionStatus(['backend_version' => '0.16.1'], '0.16.1') === 'current', 'La génération courante reste stable.');
checkReleasePolicy(backendReleaseVersionStatus(['backend_version' => '0.16.0'], '0.16.1') === 'upgrade', 'Une version strictement supérieure peut avancer.');
checkReleasePolicy(backendReleaseVersionStatus(['backend_version' => '0.16.1'], '0.16.0') === 'stale', 'Une ancienne instance ne peut pas rabaisser 0.16.1.');
...
checkReleasePolicy(backendReleaseVersionStatus(['backend_version' => '0.16.1-dev'], '0.16.0') === 'invalid', 'Une autorité non canonique échoue fermée.');
checkReleasePolicy(backendReleaseVersionStatus(['backend_version' => '0.16.1'], '00.16.0') === 'invalid', 'Une instance non canonique échoue fermée.');
