...
checkReleasePolicy(backendReleaseVersionStatus(null, '0.15.20') === 'initialize', 'Une table absente peut être initialisée.');
checkReleasePolicy(backendReleaseVersionStatus(['backend_version' => '0.15.20'], '0.15.20') === 'current', 'La génération courante reste stable.');
checkReleasePolicy(backendReleaseVersionStatus(['backend_version' => '0.15.19'], '0.15.20') === 'upgrade', 'Une version strictement supérieure peut avancer.');
checkReleasePolicy(backendReleaseVersionStatus(['backend_version' => '0.15.20'], '0.15.19') === 'stale', 'Une ancienne instance ne peut pas rabaisser 0.15.20.');
...
checkReleasePolicy(backendReleaseVersionStatus(['backend_version' => '0.15.20-dev'], '0.15.21') === 'invalid', 'Une autorité non canonique échoue fermée.');
checkReleasePolicy(backendReleaseVersionStatus(['backend_version' => '0.15.20'], '00.15.21') === 'invalid', 'Une instance non canonique échoue fermée.');
