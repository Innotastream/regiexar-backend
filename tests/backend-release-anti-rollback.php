...
checkReleasePolicy(backendReleaseVersionStatus(null, '0.16.0') === 'initialize', 'Une table absente peut être initialisée.');
checkReleasePolicy(backendReleaseVersionStatus(['backend_version' => '0.16.0'], '0.16.0') === 'current', 'La génération courante reste stable.');
checkReleasePolicy(backendReleaseVersionStatus(['backend_version' => '0.15.19'], '0.16.0') === 'upgrade', 'Une version strictement supérieure peut avancer.');
checkReleasePolicy(backendReleaseVersionStatus(['backend_version' => '0.16.0'], '0.15.19') === 'stale', 'Une ancienne instance ne peut pas rabaisser 0.16.0.');
...
checkReleasePolicy(backendReleaseVersionStatus(['backend_version' => '0.16.0-dev'], '0.15.21') === 'invalid', 'Une autorité non canonique échoue fermée.');
checkReleasePolicy(backendReleaseVersionStatus(['backend_version' => '0.16.0'], '00.15.21') === 'invalid', 'Une instance non canonique échoue fermée.');
