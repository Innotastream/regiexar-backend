# Backend OVH — Régie du Seuil 0.14.13
...
**Préparation de sources uniquement : ne pas déployer avant la vérification complémentaire et la qualification du MSIX 3.1.13.** Le commit applicatif porte `[skip ci]` pour respecter la demande de différer la construction. La production reste backend 0.14.12 / client exact 3.1.12. Statut : livraison incomplète — alerte launcher non recettée.
